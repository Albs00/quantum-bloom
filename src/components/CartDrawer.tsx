          ...
          {items.length === 0 ? (
            ...
            <>
              <div className="flex-1 overflow-y-auto pr-2 min-h-0 space-y-4">
                {items.map((item) => (
                  <div key={item.variantId} className="flex gap-4 p-4 bg-muted/50 rounded-lg border border-border">
                    ...
                    <div className="flex-1 min-w-0">
                      <h4 className="font-heading font-semibold text-foreground truncate">{item.product.node.title}</h4>
